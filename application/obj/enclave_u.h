...
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_save_wallet, (const uint8_t* data, int size));
#endif
#ifndef OCALL_LOAD_WALLET_DEFINED__
#define OCALL_LOAD_WALLET_DEFINED__
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_load_wallet, (uint8_t* data, int size));
#endif
